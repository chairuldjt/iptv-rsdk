package com.example.rsdkiptvplayer.service
...
class RemotePollerService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.example.rsdkiptvplayer.action.START_POLLER"
        const val ACTION_STOP = "com.example.rsdkiptvplayer.action.STOP_POLLER"
